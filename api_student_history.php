...
try {
    ...
    // Sınav Sonuçları
    // Not: exam_results tablosunda total_questions olmayabileceği için önce kontrol edelim ya da catch'de yakalayalım
    ...
    // Veritabanı hatası durumunda boş sonuç döndür ama JSON formatında kalsın
    echo json_encode([
        'success' => false,
        'error' => $e->getMessage(),
        'results' => []
