...
<body>
    ...
    <script>
        ...
        (function(){
            const tr = { sub:'Modern Eğitim Platformu', user:'Kullanıcı Adı veya E-posta', pass:'Şifre', phUser:'Kullanıcı adı veya e-posta girin', phPass:'Şifrenizi girin', login:'Giriş Yap', info:'Bilgi', createLabel:'Hesap Oluşturma:', createText:'Yeni bir hesap oluşturmak için lütfen eğitmeniniz veya sistem yöneticisi ile iletişime geçin.' };
            const de = { sub:'Moderne Lernplattform', user:'Benutzername oder E-Mail', pass:'Passwort', phUser:'Benutzernamen oder E-Mail eingeben', phPass:'Passwort eingeben', login:'Anmelden', info:'Hinweis', createLabel:'Kontoerstellung:', createText:'Für ein neues Konto wenden Sie sich an Ihre Lehrkraft oder den Systemadministrator.' };
            ...
            function setText(sel, text){ 
                ...
                if(el.tagName==='INPUT'){ 
                    ...
                    if(el.id === 'infoTitle') {
                        ...
                        // For labels that might have icons or structure, we should only replace the text.
                        // Ideally we wrap text in span but here we know the structure.
                        // labelUser has just text (remote has label, local has label)
                        // Wait, remote label has just text.
                        el.textContent = text; 
                    }
                } 
            }
