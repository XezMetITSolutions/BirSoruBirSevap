<?php
/**
 * Eğitim Başkanı - Sınavlar (Sadece Görüntüleme)
 */
...
// Sınavları getir (kendi şubesinden)
try {
...
<head>
    ...
    <title>Sınavlar - <?php echo htmlspecialchars($userBranch); ?></title>
    ...
    <div class="main-wrapper">
        <div class="top-bar">
            ...
            <div class="welcome-text">
                <h2>Sınavlar</h2>
                <p><?php echo htmlspecialchars($userBranch); ?> - Sınav Listesi</p>
            </div>
        </div>
